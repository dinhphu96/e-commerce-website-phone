...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="/asm1/index" class="nav-item nav-link">Trang chủ</a>
                            <a href="/asm1/product.jsp" class="nav-item nav-link active">Sản phẩm</a>
                            <a href="#" class="nav-item nav-link">About</a>
                            <a href="/asm1/contact" class="nav-item nav-link">Liên hệ</a>
                        </div>
                        </div>
    ...
    <div class="container-fluid bg-secondary mb-5">
        ...
        <img alt="không tìm thấy hình" src="/asm1/img/posterlaptop1.jpg" style="width:100%; position:relative;" >
	                        ...
	                        <div class="card product-item border-0 mb-4">
	                            ...
	                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
	                                ...
	                                <div class="d-flex justify-content-center">
	                                    <h6>${item.price}</h6><h6 class="text-muted ml-2"><del>DISCOUNT</del></h6>
	                                </div>
	                            </div>
	                            <div class="card-footer d-flex justify-content-between bg-light border">
	                                <a href="/java4_asm/detail?idSelected=${item.ID_Product}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
