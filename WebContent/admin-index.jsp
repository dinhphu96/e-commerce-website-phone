...
<body id="page-top" onload="onloadAreaChart(${doanhThuItem}, ${doanhThuValue}); onloadPieChart(${pieChart})">
					...
					<div class="row">
						...
						<div class="col-xl-4 col-lg-5">
							<div class="card shadow mb-4">
								...
								<div
									class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 class="m-0 font-weight-bold text-primary">Tỉ lệ bán sản phẩm các loại</h6>
									<div class="dropdown no-arrow">
										<a class="dropdown-toggle" href="#" role="button"
											id="dropdownMenuLink" data-toggle="dropdown"
											aria-haspopup="true" aria-expanded="false"> <i
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; TMTP 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="<c:url value="/myJs/doanhThuChart.js" />"></script>
    <script src="<c:url value="/myJs/my-chart-pie.js" />"></script>
