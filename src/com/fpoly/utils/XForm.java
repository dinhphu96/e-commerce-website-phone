...
import static com.fpoly.utils.RRSharer.request;
...
public class XForm {
	static HttpSession session = RRSharer.request().getSession();
	static ServletContext XHttp = session.getServletContext();
